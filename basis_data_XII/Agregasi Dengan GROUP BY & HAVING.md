...
*HASIL :*
![](assest/pembuata_table_basisdata.PNG)

## 2. Gunakan perintah DESC pegawai; untuk mendapatkan struktur tabel.
*STRUKTUR "*
~~~SQL
CREATE TABLE pegawai (
-> NIP INT PRIMARY KEY,
...
*HASIL :*
![](assest/desc_pegawai_basisdata.PNG)

## 3. Gunakan perintah SELECT * FROM pegawai; untuk mendapatkan data.
*STRUKTUR "*
~~~SQL
...
*HASIL :
![](assest/hasil_table_basisdata.PNG)
